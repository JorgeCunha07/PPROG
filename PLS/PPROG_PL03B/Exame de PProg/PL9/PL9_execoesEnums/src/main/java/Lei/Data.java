...
public class Data implements Comparable<Data> {
    ...
    /**
     * Constrói uma instância de Lei.Data recebendo o ano, o mês e o dia.
     *
    ...
    /**
     * Constrói uma instância de Lei.Data com a data por omissão.
     */
    public Data() {
        ano = ANO_POR_OMISSAO;
        mes = MES_POR_OMISSAO;
    ...
    /**
     * Constrói uma instância de Lei.Data com as mesmas caraterísticas da data
    ...
    public boolean checkAno(int ano){
        ...
        throw new RuntimeException("Ano" + ano + "maior ao ano atual.");
    }

    public boolean checkMes(int mes,int ano){
        Data aux = dataAtual();
         if (ano <= aux.getAno() ){

             return mes <= Mes.values().length;

         }else
             throw new RuntimeException("Mês " + mes + "não é valido");
    }
    public boolean checkDia(int dia,int mes,int ano){
        Data aux = dataAtual();
        if (ano <= aux.getAno() && mes <= Mes.values().length){
           int dias =  Mes.obterMes(mes).numeroDeDias;
            return dia <= dias;
    }
        throw new RuntimeException("Dia" + dia + "Invalido");
    }
