...
public class JanelaPrincipalUI implements Initializable {
    ...
    private static final String MENU_TAREFA_MENU_REMOVER_SELECCIONADA = "Selecionada";
...
//    private static final String MENU_FICHEIRO = "File";
//    private static final String MENU_FICHEIRO_GUARDAR_TEXTO = "Save as text";
//    private static final String MENU_FICHEIRO_GUARDAR_BINARIO = "Save as binary";
//    private static final String MENU_FICHEIRO_GUARDAR_SAIR = "Exit";
//    
//    private static final String MENU_TAREFA = "Task";
//    private static final String MENU_TAREFA_ADICIONAR = "Add";
//    private static final String MENU_TAREFA_MENU_REMOVER = "Remove";
//    private static final String MENU_TAREFA_MENU_REMOVER_SELECCIONADA = "Selected";
//    private static final String MENU_TAREFA_MENU_REMOVER_TODAS = "All";
//    
...
//    private static final String CABECALHO_REMOVER_TAREFA = "Remove Task";
//    private static final String CONTEXTO_REMOVER_TAREFA = "Do you confirm the removal of the following task?";
//    private static final String CABECALHO_GUARDAR_FICHEIRO_TEXTO = "Save list in text file";
//    private static final String CONTEXTO_CONFIRMAR_GUARDAR_FICHEIRO_TEXTO = "Do you wish to save the list to a text file?";
//    private static final String CONTEXTO_SUCESSO_GUARDAR_FICHEIRO_TEXTO = "Text file successully saved";
//    private static final String CONTEXTO_INSUCESSO_GUARDAR_FICHEIRO_TEXTO = "Couldn't save text file";
//    
//    private static final String CABECALHO_GUARDAR_FICHEIRO_BINARIO = "Save list in binary file";
//    private static final String CONTEXTO_CONFIRMAR_GUARDAR_FICHEIRO_BINARIO = "Do you wish to save the list to a binary file??";
//    private static final String CONTEXTO_SUCESSO_GUARDAR_FICHEIRO_BINARIO = "Binary file successffully saved";
//    private static final String CONTEXTO_INSUCESSO_GUARDAR_FICHEIRO_BINARIO = "Couldn't save binary file";
    ...
    public void initialize(URL url, ResourceBundle rb) {
        ...
        try {
            ...
            AlertaUI.criarAlerta(Alert.AlertType.ERROR, 
                     TITULO_ALERTA_LISTA_TAREFAS, CABECALHO_ERRO_FATAL, ex.getLocalizedMessage()).showAndWait();
            Platform.exit();
        }
    }
    ...
    private void mnuFicheiroGuardarTextoAction(ActionEvent event) {
        if (AlertaUI.criarAlerta(Alert.AlertType.CONFIRMATION,
                 TITULO_ALERTA_LISTA_TAREFAS, CABECALHO_GUARDAR_FICHEIRO_TEXTO,
                CONTEXTO_CONFIRMAR_GUARDAR_FICHEIRO_TEXTO).showAndWait().get() == ButtonType.OK) {
            boolean guardou = appController.guardarFicheiroTexto();

            AlertaUI.criarAlerta(guardou ? Alert.AlertType.INFORMATION : Alert.AlertType.ERROR,
                     TITULO_ALERTA_LISTA_TAREFAS, CABECALHO_GUARDAR_FICHEIRO_TEXTO,
                    guardou ? CONTEXTO_SUCESSO_GUARDAR_FICHEIRO_TEXTO
                            : CONTEXTO_INSUCESSO_GUARDAR_FICHEIRO_TEXTO).show();
        }
    }
    ...
    private void mnuFicheiroGuardarBinarioAction(ActionEvent event) {
        if (AlertaUI.criarAlerta(Alert.AlertType.CONFIRMATION,
                 TITULO_ALERTA_LISTA_TAREFAS, CABECALHO_GUARDAR_FICHEIRO_BINARIO,
                CONTEXTO_CONFIRMAR_GUARDAR_FICHEIRO_BINARIO).showAndWait().get() == ButtonType.OK) {
            boolean guardou = appController.guardarFicheiroBinario();

            AlertaUI.criarAlerta(guardou ? Alert.AlertType.INFORMATION : Alert.AlertType.ERROR,
                     TITULO_ALERTA_LISTA_TAREFAS, CABECALHO_GUARDAR_FICHEIRO_BINARIO,
                    guardou ? CONTEXTO_SUCESSO_GUARDAR_FICHEIRO_BINARIO
                            : CONTEXTO_INSUCESSO_GUARDAR_FICHEIRO_BINARIO).show();
        }
    }
    ...
    private void mnuTarefaRemoverSeleccionadaAction(ActionEvent event) {
        ...
        Alert alertaConfirmacaoAccao = AlertaUI.criarAlerta(Alert.AlertType.CONFIRMATION,
                 TITULO_ALERTA_LISTA_TAREFAS, CABECALHO_REMOVER_TAREFA,
    ...
    private void teclaPressionadaAction(KeyEvent event) {
        if (event.isShortcutDown()) {
            if (!appController.listaVazia()) {
                ...
                AlertaUI.criarAlerta(Alert.AlertType.ERROR,  TITULO_ALERTA_LISTA_TAREFAS,
                        CABECALHO_ERRO_FUNCAO, MENSAGEM_LISTA_VAZIA).show();
            }
        }
    }
    ...
    private void iniciarControlos() {
        ...
        mnuTarefaRemoverSeleccionada.setText(MENU_TAREFA_MENU_REMOVER_SELECCIONADA);
    ...
    private void atualizarListaTarefas(ListaTarefas.ORDENACAO ordem) {
        lstViewTarefas.getItems().setAll(
                ordem == ListaTarefas.ORDENACAO.INSERCAO
                        ? appController.getArrayListTarefas()
                        : appController.getArrayListTarefasPorPrioridade());
    }
}
